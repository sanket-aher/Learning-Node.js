/* Ex2 : Activity : Q.Create a basic template for instagram page based on following route /ig/:username */
/*
    Git Bash/Terminal :
    Sanket Aher@DESKTOP-7UDIT7I MINGW64 /E/Learning/NodeJS Learn/NodeJS Part3/EJSDIR02/Ex02(Activity)
...
app.get("/ig/:username",(req,res)=>{
    ...
    res.render("instagram.ejs",{username}); // OR res.render("instagram.ejs",{username:username});
});
